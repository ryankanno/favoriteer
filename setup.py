...
with open(os.path.join(here, 'py_favoriteer/__init__.py'), 'r') as f:
    for line in f:
...
setup(
    ...
    description='Get all your twitter favorites',
    long_description=readme + '\n\n' + changes,
    author=meta['author'],
    author_email=meta['email'],
    url="https://github.com/ryankanno/py-favoriteer",
    packages=packages,
    package_data={'': ['LICENSE']},
    package_dir={'py_favoriteer': 'py_favoriteer'},
